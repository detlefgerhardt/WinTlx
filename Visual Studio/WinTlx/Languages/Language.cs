...
namespace WinTlx.Languages
{
	public enum LngKeys
	{
		...
		MainForm_TextEditorButton,
		MainForm_TextEditorButton_ToolTip,
		MainForm_SaveImageButton,
		MainForm_SaveImageButton_ToolTip,
		MainForm_SaveBufferButton,
		MainForm_SaveBufferButton_ToolTip,
		...
		TapePunch_ReverseButton,
		TapePunch_ReverseButton_ToolTip,
