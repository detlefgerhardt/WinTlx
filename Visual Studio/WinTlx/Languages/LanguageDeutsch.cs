	...
	class LanguageDeutsch
	{
		public static Language GetLng()
		{
			...
			lng.Items = new Dictionary<LngKeys, string>
			{
				...
				{ LngKeys.MainForm_RecvActive, "Empf. aktiv" },
				{ LngKeys.MainForm_RecvInactive, "Empf. inaktiv" },
				{ LngKeys.MainForm_CentralexActive, "Centralex aktiv" },
				...
				{ LngKeys.Setup_RemoteBufferSize, "Rem-Puffer (Byte) / Freq. (ms)" },
				...
				{ LngKeys.TapePunch_NewButton, "Neu" },
				{ LngKeys.TapePunch_NewButton_ToolTip, "Neuen LS starten" },
				{ LngKeys.TapePunch_ClearButton, "Löschen" },
				{ LngKeys.TapePunch_ClearButton_ToolTip, "LS-Speicher löschen" },
				...
				{ LngKeys.Message_Connecting, "verbinde" },
				...
				{ LngKeys.Message_InvalidConnectionData, "ungueltige verbindungsdaten" },
				...
				//{ LngKeys.Message_ConnectionTimeout, "zeitueberschreitung beim verbindungsaufbau" },
