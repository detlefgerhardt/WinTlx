	...
	class LanguageDeutsch
	{
		public static Language GetLng()
		{
			...
			lng.Items = new Dictionary<LngKeys, string>
			{
				...
				{ LngKeys.MainForm_DisconnectButton, "Unterbrechen" },
				...
				{ LngKeys.MainForm_SendBellButton, "Glocke" },
				...
				{ LngKeys.Setup_InactivityTimeout, "Inaktivitäts-Timeout" },
				...
				{ LngKeys.Message_Disconnected, "verbindung beendet" },
				{ LngKeys.Message_Reject, "reject" },
				{ LngKeys.Message_InactivityTimeout, "inaktivitaetstimeout" },
				...
				{ LngKeys.Message_QueryResult, "teilnehmer gefunden" },
